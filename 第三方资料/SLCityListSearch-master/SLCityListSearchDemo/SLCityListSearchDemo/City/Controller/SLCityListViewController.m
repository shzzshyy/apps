...
- (SLCityLocationView *)cityLocationView {
    if (!_cityLocationView) {
        _cityLocationView = [[SLCityLocationView alloc] initWithFrame:CGRectMake(0, 88, kScreenWidth, 40)];
    }
...
- (UITableView *)tableView {
    if (!_tableView) {
        _tableView = [[UITableView alloc] initWithFrame:CGRectMake(0, CGRectGetMaxY(self.cityLocationView.frame), kScreenWidth, kScreenHeight) style:UITableViewStylePlain];
