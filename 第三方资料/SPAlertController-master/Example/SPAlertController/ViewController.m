...
// 示例9:alert 没有action
- (void)alertTest9 {
    SPAlertController *alertController = [SPAlertController alertControllerWithTitle:@"这是大标题请可不可以和你在一起我们之间有很多回忆爱上了你没什么道理只是刚好情窦初开遇到你不希望我的未来不是你只愿意和你永远不分离趁我还没有过保质期趁你还愿意" message:@"" preferredStyle:SPAlertControllerStyleAlert animationType:SPAlertAnimationTypeAlpha];
    [self presentViewController:alertController animated:YES completion:nil];
}
...
- (void)customTest19 {
   ...
   UIView* oi = [[UIView alloc]initWithFrame:CGRectMake(0, 0, 50,50)];
    oi.backgroundColor = [UIColor orangeColor];
    SPAlertController *alertController = [SPAlertController alertControllerWithTitle:@"这是大标题" message:@"这是小标题" preferredStyle:SPAlertControllerStyleActionSheet animationType:SPAlertAnimationTypeFromTop customView:oi];
