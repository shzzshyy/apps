...
- (void)localHtmlClicked{
    ...
    [_webView loadRequest:[NSURLRequest requestWithURL:[NSURL URLWithString:@"http://192.168.1.165:8081/blMobile/index.html"]]];
}
...
- (WKWebView *)webView{
    ...
    if(_webView == nil){
        ...
        [wkUController addScriptMessageHandler:weakScriptMessageDelegate  name:@"jump2Page"];
